        ...
        \begin{column}{0.5\linewidth}
            \begin{figure}
                ...
                \begin{subfigure}{.5\columnwidth}
                        \caption*{\tiny {\color{red}Pattern with platform and antennas (in-situ) similar}}%
                        \includegraphics[width=\columnwidth,height=\columnwidth]{../paper/FIG/rand.png}
                \end{subfigure}\\\vfill
                \only<2>{
                \begin{subfigure}{.5\columnwidth}
                    \caption*{\tiny {\color{blue}Pattern with platform and antennas (in-situ) similar to free-space pattern}}%
                    \includegraphics[width=\columnwidth, height=\columnwidth]{../paper/FIG/best.png}%
                \end{subfigure}\hfill\\}%
            \end{figure}
