        ...
        \begin{column}{0.3\linewidth}
            \only<2->
            {
                \begin{figure}
                    ...
                    \caption*{\tiny Population for last generation of a run. Notice that search becomes restricted to some local optimums}
                \end{figure}
            }
        \end{column}
    \end{columns}
        ...
        \begin{column}{0.3\linewidth}
            \only<2->
            {
                \begin{figure}
                    ...
                    \caption*{\tiny Greedy approach to accept only fitter(low fitness) individuals}
                \end{figure}
            }
        \end{column}
    \end{columns}
