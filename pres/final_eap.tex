    ...
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            ...
            \begin{figure}
                ...
                \centering
                \includegraphics[scale=0.25]{../paper/FIG/free_cross.png}
                \caption*{\tiny {2D view of the free space gain pattern}}%
            \end{subfigure}\vspace*{2mm}
            \begin{subfigure}{\columnwidth}
                \centering
                \includegraphics[scale=0.25]{../paper/FIG/comp_cross.png}
                \caption*{\tiny {In-situ pattern (in red) for random antenna placements}}%
            \end{subfigure}
            \end{figure}
        }
        \end{column}
