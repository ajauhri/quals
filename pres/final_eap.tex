...
\begin{itemize} \itemsep1.5em
    ...
    \end{itemize}
    \vspace{10px}
    \centering\only{\textbf{Problem}: Find a set of $n$ optimal antenna placements on $P$ to maximize gain and minimize coupling}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            ...
            \begin{figure}
                \vspace*{-1cm}
                \centering
                \includegraphics[width=4cm,height=5cm]{../paper/FIG/rand.png}
