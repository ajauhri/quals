...
\begin{frame}{Antenna Placement Problem}
    ...
    \begin{columns}
        ...
        \only<2->{
            \begin{textblock}{3}(-1,1)\textbf{Problem:} find best antenna placements \end{textblock}
            \begin{textblock}{3}(2.5,-0.1)
                \begin{figure}
                    \includegraphics[trim=170 165 70 15, clip, scale=0.4]{../paper/FIG/tc11_intro}
                \end{figure}\end{textblock}
        }
        \column{0.33\linewidth}
        \only<1->{
...
\begin{frame}{\null}
    \begin{tcolorbox}[colback=green!5]
        \centering\Huge
        Part 3: Results of our experiments
    \end{tcolorbox}
\end{frame}
