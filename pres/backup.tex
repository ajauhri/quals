...
\begin{frame}{Parameter Selection - Temperature (SA)}
    Initial temperature selected using technique mentioned by [2]. It is important to note that acceptance rate drops monotonically with temperature. 
    \vspace*{.5cm}
    \begin{enumerate}
    ...
    \end{enumerate}
    {\tiny [2] Dowsland, K. A., \& Thompson, J. M. (2012). Simulated annealing. In Handbook of Natural Computing (pp. 1623-1655). Springer Berlin Heidelberg. }
\end{frame}
