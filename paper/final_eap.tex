...
To summarize, Figure \ref{fig:tc_mf} shows that ES was successful in finding optimum candidate solutions for all test cases. Alternatively, SA took less number of fitness evaluations to converge but had a lower probability to succeed by finding the optimum solution.
\begin{figure*}
    \centering
    \begin{subfigure}{\columnwidth}
